...
{{
    ...
    "image_prompt": "A high-quality, professional, realistic photography related to {topic}. Bright and clean atmosphere. No text, no people, minimalist composition, 8k resolution."
}}
"""
...
{{
    ...
    "tags": ["태그1", "태그2", "태그3", "태그4", "태그5"],
    "image_prompt": "A high-quality, professional, realistic photography related to {topic}. Minimalist and modern style. No text, no background noise, centered composition, high quality."
}}
"""
